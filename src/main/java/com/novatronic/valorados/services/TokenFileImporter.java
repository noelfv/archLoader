...
public class TokenFileImporter implements TokenFileImporterMBean {

    private final static Logger logger = Logger.getLogger(TokenFileImporter.class);
...
//
        ...
        tok.setPathTrabajo("E:\\temp\\in");
        tok.setPathHistorico("E:\\temp\\hist");
        tok.setPathErrores("E:\\temp\\errores");
